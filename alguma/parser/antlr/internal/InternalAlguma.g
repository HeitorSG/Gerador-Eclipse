...
@lexer::header {
package heitor.uni.comp.alguma.parser.antlr.internal;
...
import heitor.uni.comp.alguma.services.AlgumaGrammarAccess;
			...
			(
				...
				lv_declaracoes_2_0=ruleDeclaracao
				{
					...
					add(
						...
						"declaracoes",
						lv_declaracoes_2_0,
						"heitor.uni.comp.alguma.Alguma.Declaracao");
			...
			(
				...
				lv_comandos_5_0=ruleComando
				{
					...
					add(
						...
						"comandos",
						lv_comandos_5_0,
						"heitor.uni.comp.alguma.Alguma.Comando");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_tipo_2_0=ruleTipoVar
				{
					...
					set(
						...
						"tipo",
						lv_tipo_2_0,
						"heitor.uni.comp.alguma.Alguma.TipoVar");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_termo1_0_0=ruleTermoAritmetico
				{
					...
					set(
						...
						"termo1",
						lv_termo1_0_0,
						"heitor.uni.comp.alguma.Alguma.TermoAritmetico");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_outrosTermos_1_0=ruleOutroTermoAritmetico
				{
					...
					add(
						...
						"outrosTermos",
						lv_outrosTermos_1_0,
						"heitor.uni.comp.alguma.Alguma.OutroTermoAritmetico");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_operador_0_0=ruleOpArit1
				{
					...
					set(
						...
						"operador",
						lv_operador_0_0,
						"heitor.uni.comp.alguma.Alguma.OpArit1");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_fator1_0_0=ruleFatorAritmetico
				{
					...
					set(
						...
						"fator1",
						lv_fator1_0_0,
						"heitor.uni.comp.alguma.Alguma.FatorAritmetico");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_outrosFatores_1_0=ruleOutroFatorAritmetico
				{
					...
					add(
						...
						"heitor.uni.comp.alguma.Alguma.OutroFatorAritmetico");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_operador_0_0=ruleOpArit2
				{
					...
					set(
						...
						"operador",
						lv_operador_0_0,
						"heitor.uni.comp.alguma.Alguma.OpArit2");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_expressao_1_0=ruleExpressaoAritmetica
				{
					...
					set(
						...
						"expressao",
						lv_expressao_1_0,
						"heitor.uni.comp.alguma.Alguma.ExpressaoAritmetica");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_termo1_0_0=ruleTermoRelacional
				{
					...
					set(
						...
						"termo1",
						lv_termo1_0_0,
						"heitor.uni.comp.alguma.Alguma.TermoRelacional");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_outrosTermos_1_0=ruleOutroTermoRelacional
				{
					...
					add(
						...
						"outrosTermos",
						lv_outrosTermos_1_0,
						"heitor.uni.comp.alguma.Alguma.OutroTermoRelacional");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_operador_0_0=ruleOpBool
				{
					...
					set(
						...
						"operador",
						lv_operador_0_0,
						"heitor.uni.comp.alguma.Alguma.OpBool");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_opRel_1_0=ruleOpRel
				{
					...
					set(
						...
						"opRel",
						lv_opRel_1_0,
						"heitor.uni.comp.alguma.Alguma.OpRel");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_expRel_1_0=ruleExpressaoRelacional
				{
					...
					set(
						...
						"expRel",
						lv_expRel_1_0,
						"heitor.uni.comp.alguma.Alguma.ExpressaoRelacional");
					afterParserOrEnumRuleCall();
				}
			)
		)
...
@after {
	...
	(
		...
		{
			$current.merge(kw);
			newLeafNode(kw, grammarAccess.getOpArit1Access().getEqualsSignKeyword_2());
		}
	)
;
